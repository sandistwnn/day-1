...
module.exports = function setupSocket(io) {
 ...
 io.use((socket, next) => {
    try {
      ...
      if (!secret) {
        console.error("[Socket Error] JWT_SECRET tidak ditemukan di environment/config!");
        return next(new Error("Internal Server Error: Auth configuration missing"));
      }
      ...
      console.error("[Socket Auth Error]:", err.message); // Log error asli
